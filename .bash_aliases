...
for file in $(find ~/bashrc -type d -name .git -prune -o -type f -name .bash_aliases -prune -o -type f -name hud -prune -o -type f -name .vimrc -prune -o -type f -name .toprc -prune -o -type f -print); do
  source_alias $file
done
